          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">
                Equal<span className="text-primary-400">Ed</span>
              </span>
            </div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="hover:text-primary-400 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-400 rounded"
